...
print a({-href => 'http://feldgendler.livejournal.com/155015.html'}, 'Here'), " is a link to the original discussion, in Russian; 
...
print "Alexander Fenster, fenster<span id=\"at\"></span>fenster<span id=\"dot\"></span>name, ", a({-href => 'https://plus.google.com/+AlexanderFenster'}, 'https://plus.google.com/+AlexanderFenster'), '.';
